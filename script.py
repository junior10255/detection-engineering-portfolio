#!/usr/bin/env python3
"""
Detection Engineering Portfolio - Xtreme v14.0 (Architect Edition)
=====================================================================
...
✔ Score percentual normalizado e limitado a 100%.
✔ Métricas renomeadas para clareza executiva.
"""
...
def main():
    base = os.getcwd()
    log("Iniciando Xtreme Organizer v14.0...")
    ...
    ignored_dirs = {'.git', 'audit', 'img', 'research', 'tools', 'Sigma'}
    ...
    # Densidade real: regras por tática ativa
    ...
    # Ordenação SOC: severidade (critical=4, high=3, ...) depois qualidade
...
---
*Gerado via {SCRIPT_NAME} v14.0 em {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}*
"""
